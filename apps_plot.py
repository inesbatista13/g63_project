"""
G63 — apps_plot.py
Matplotlib charts (static PNG via base64)
Follows professor's pattern from lesson 13 apps_plot.py
...
def apps_plot():
    ...
    if ulogin is not None:
        ...
        plt.title('Total Spent per Supermarket Chain')
        ...
        plt.title('Transations per Supplier Type')
        plt.xticks(rotation=20, ha='right')
        plt.tight_layout()
